...
class SqlGeneratorTest {
    ...
    private final String CLIENT_NAME_DEF="client_name varchar(255) not null";
    private final String UNIQUE_STRING_DEF="unique_string varchar(255) unique";
    private final String ID_DEF="id BIGINT primary key auto_increment";
